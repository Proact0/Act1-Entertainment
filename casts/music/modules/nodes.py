...
from agents.music.modules.prompts import (
    get_lyric_template,
    get_diary_template,
    get_query_extraction_template,
    get_youtube_analysis_template,
)
from agents.music.modules.state import MusicState
from agents.music.modules.models import (
    get_openai_model,
    get_gemini_client,
    get_youtube_client,
)
...
class DiaryGenerationNode(BaseNode):
    ...
    def execute(self, state) -> dict:
        ...
        second_prompt = get_query_extraction_template().format(
            query=state["diary_query"]
        )
        messages = [
            {
                "role": "user",
